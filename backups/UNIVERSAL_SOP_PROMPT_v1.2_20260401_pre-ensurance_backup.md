# Universal Output SOP — v1.2
# VERSION: 1.2 | Updated: 2026-03-31 | Previous: v1.1 (backed up)
...
SOP_VERSION: 1.2              # This file's version (auto-referenced)
```
...
```
## ✅ UNDERSTANDING CHECK
SOP: v1.2 | TIER: [QUICK/STANDARD/COMPLEX]
...
```
📁 [project root]/
├── 📄 UNIVERSAL_SOP_PROMPT.md       ← VERSION: 1.2 (this SOP)
├── 📁 cache/
...
*Universal Output SOP (Standard Operating Procedure) v1.2 — The foundation. Paste into any new session. Works for any project.*
*SOP VERSION: 1.2 | Created: 2026-03-31 | 16 SubSOPs | 6 Stages | Acronym-expanded*
