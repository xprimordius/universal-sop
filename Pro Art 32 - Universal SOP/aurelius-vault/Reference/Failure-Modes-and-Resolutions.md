...
| 12 | Vault folder accidentally moved/renamed on disk | Local copy unreachable but GitHub still has it | ✅ Resolved: `git clone github.com/xprimordius/aurelius-vault` recovers from canonical remote. |
