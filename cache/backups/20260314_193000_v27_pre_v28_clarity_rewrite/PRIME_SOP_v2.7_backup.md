# PRIME SOP v2.7 — The Unconditional Foundation
...
**Updated:** March 14, 2026 — Session 10 (v2.7: Systematic source chains for all 32 checklist items, token session reset clarity, YELLOW auto-checkpoint enforcement gates.)
**Previous Version:** v2.6 backed up at `cache/backups/20260314_190000_v26_pre_v27_source_chains_token_reset/PRIME_SOP_v2.6_backup.md`
...
**Total: 24 checklist items. Each has: PASS criteria + source prompt # + exact verbatim quote + file path + line range.**
**Source file: `cache/USER_PROMPTS_VERBATIM.md`**
...
*Prime SOP v2.7 — The foundation that cannot be broken. Everything else is built on this.*
