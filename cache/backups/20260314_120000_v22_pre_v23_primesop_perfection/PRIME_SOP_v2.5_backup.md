# PRIME SOP v2.5 — The Unconditional Foundation
...
**Updated:** March 14, 2026 — Session 8 (v2.5: Token thresholds corrected to 180K actual limit per Alan's directive. Stage 3 expanded with comprehensive token tracking, count, usage, checkpoint, and backup rules.)
**Previous Version:** v2.4 backed up at `cache/backups/20260314_120000_v22_pre_v23_primesop_perfection/PRIME_SOP_v2.4_backup.md`
...
*Prime SOP v2.5 — The foundation that cannot be broken. Everything else is built on this.*
