...
# Prepared by scripts/invoke_sub_agent.sh on 2026-05-25 04:16 CDT
# Device: aurelion
# Role:   code-reviewer

## Your context (fresh brain — no prior session bias)

You are reviewing the artifact at `scripts/add_protocol.sh` against the spec at `cache/SESSION_STATE.md`.
...
1. Read `cache/SESSION_STATE.md` end-to-end. Extract the literal requirements.
2. Read `scripts/add_protocol.sh` end-to-end. Note every claim it makes.
...
`cache/sub_agent_invocations/20260525_041641_code-reviewer_result.md`.
