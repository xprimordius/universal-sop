...
**Device:** aurelion
**Date:** 2026-05-25 01:44
**Commit:** 5aab7c8
**Verdict:** 🔴 DEGRADED — 39 issues
...
| 2/10 | Protocol coverage drift | 17 |
| 3/10 | BACKUP_LOG integrity | 17 |
| 4/10 | Dead refs in docs | 5 |
...
── DIRECTION B: scripts/ + agents/ → PROTOCOLS_REFERENCE entry
  ...
  ⚠️ 7 script(s) missing formal entry:
       • backup_before_rewrite.sh
       • backup_status.sh
       • checkpoint.sh
       • mirror_obsidian.sh
       • pristine_audit.sh
