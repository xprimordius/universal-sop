...
**Device:** aurelia
**Date:** 2026-05-23 01:57
**Commit:** ceafa06
**Verdict:** 🔴 DEGRADED — 36 issues

## Sub-audit results

| # | Audit | Issues |
|:-:|---|:-:|
| 1/10 | E2E foundational sweep | 1 |
| 2/10 | Protocol coverage drift | 11 |
| 3/10 | BACKUP_LOG integrity | 23 |
...
VERDICT: ❌ 1 CHECK(S) FAILED — investigate above
═══════════════════════════════════════════════════════════════
```
...
```
  ...
  ✅ EN.4  Pulse Pulse Check                       14/20 commits ( 70%)
